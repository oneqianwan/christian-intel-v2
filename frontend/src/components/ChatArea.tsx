...
const hasPartnershipActionPlanPayload = (value: unknown): value is PartnershipActionPlanPayload => {
  if (!value || typeof value !== 'object') return false
  const candidate = value as Record<string, unknown>
  return Array.isArray(candidate.action_plan) &&
    Array.isArray(candidate.warnings) &&
    typeof candidate.summary === 'object' &&
    candidate.summary !== null &&
            ...
            addMessage(convId!, {
              ...
              partnership_recommendations: hasPartnershipRecommendationPayload(data.partnership_recommendations)
                ...
                : hasPartnershipRecommendationPayload(delivery.partnership_recommendations)
                  ...
                  : undefined,
              partnership_action_plan: hasPartnershipActionPlanPayload(data.partnership_action_plan)
                ? data.partnership_action_plan
